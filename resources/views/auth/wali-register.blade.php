        ...
        <div class="hidden lg:flex w-1/2 items-center justify-center bg-gray-900 p-12 text-white relative overflow-hidden">
            ...
            <div class="relative z-10 text-center space-y-8">
                ...
                <h1 class="text-4xl font-bold tracking-tight text-white">
                    Pendaftaran Akun Wali Santri
                </h1>
                <p class="mt-4 text-lg text-red-100 max-w-lg mx-auto">
                    Daftarkan akun Anda untuk memantau perkembangan dan informasi penting mengenai santri.
                </p>
            </div>
        </div>
            ...
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 sm:p-10">
                    <div class="text-left mb-8">
                        <h2 class="text-3xl font-bold tracking-tight text-gray-900">Buat Akun Wali</h2>
                        <p class="mt-2 text-slate-600">Silakan isi data berikut untuk mendaftar.</p>
                    </div>

                    <form method="POST" action="{{ route('wali.register') }}" class="space-y-6">
                        @csrf

                        <!-- Name -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap Wali</label>
                            <div class="relative">
                                ...
                                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" placeholder="Nama Anda"
                                       class="block w-full rounded-lg border-gray-300 py-3 pl-11 pr-4 text-gray-900 shadow-sm placeholder:text-gray-400 focus:border-red-500 focus:ring-1 focus:ring-red-500 sm:text-sm">
                            </div>
                        ...
                        <!-- Kode Registrasi -->
                        <div>
                            <label for="kode_registrasi_wali" class="block text-sm font-medium text-gray-700 mb-1">Kode Registrasi Wali</label>
                            <div class="relative">
                                 <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                                    <svg class="h-5 w-5 text-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M11.49 3.17a.75.75 0 01.47.458l2.25 4.5a.75.75 0 01-.47 1.022l-4.5 2.25a.75.75 0 01-1.022-.47l-2.25-4.5a.75.75 0 01.47-1.022l4.5-2.25a.75.75 0 01.552 0zM4.75 5.5a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5a.75.75 0 01-.75-.75zM4.75 8.5a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5a.75.75 0 01-.75-.75zM4 11.5a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5A.75.75 0 014 11.5z" clip-rule="evenodd" /></svg>
                                </div>
                                <input id="kode_registrasi_wali" type="text" name="kode_registrasi_wali" value="{{ old('kode_registrasi_wali') }}" required placeholder="KODE-UNIK"
                                       class="block w-full rounded-lg border-gray-300 py-3 pl-11 pr-4 text-gray-900 shadow-sm placeholder:text-gray-400 focus:border-red-500 focus:ring-1 focus:ring-red-500 sm:text-sm">
                            </div>
                             <x-input-error :messages="$errors->get('kode_registrasi_wali')" class="mt-2" />
                            <p class="text-xs text-gray-500 mt-1">Dapatkan kode ini dari pihak administrasi pondok.</p>
                        </div>
