            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                        <div>
                            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Laporan Pelanggaran</h1>
                            <p class="mt-1 text-slate-600">Filter dan ekspor rekap data pelanggaran santri.</p>
                        </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border border-slate-200">
                    <form action="{{ route('laporan.pelanggaran') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                        <div>
                        ...
                        <div class="flex items-end space-x-2">
                            ...
                            <a href="{{ route('laporan.pelanggaran.export', request()->query()) }}" class="w-full inline-flex justify-center py-2 px-4 rounded-md text-white bg-green-600 hover:bg-green-500 shadow-sm">Export</a>
                        </div>
                    </form>
                </div>
