                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row items-start gap-6">
                            ...
                            <div class="flex-shrink-0" x-data="{ open: false }">
                                <div class="relative">
                                    <button @click="open = !open" class="inline-flex items-center justify-center rounded-md bg-red-700 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-600">
