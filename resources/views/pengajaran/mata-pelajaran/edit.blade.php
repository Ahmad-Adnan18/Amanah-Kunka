        ...
        <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
                    <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-slate-600">Perbarui detail untuk: <span class="font-semibold text-red-700">{{ $mataPelajaran->nama_pelajaran }}</span></p>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                    <form action="{{ route('pengajaran.mata-pelajaran.update', $mataPelajaran) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <select name="kategori" id="kategori" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-red-500 focus:ring-red-500">
                                    <option value="Umum" @selected(old('kategori', $mataPelajaran->kategori) == 'Umum')>Umum</option>
                                    <option value="Diniyah" @selected(old('kategori', $mataPelajaran->kategori) == 'Diniyah')>Diniyah</option>
                                </select>
