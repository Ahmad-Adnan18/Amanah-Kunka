                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                    <table class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="bg-white divide-y divide-slate-200">
                            @forelse ($jabatans as $jabatan)
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="px-6 py-4 text-right space-x-4">
                                        ...
                                        <form action="{{ route('pengajaran.jabatan.destroy', $jabatan) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus jabatan ini?')">
                                            @csrf @method('DELETE')
                            ...
                            @empty
                                <tr><td colspan="2" class="px-6 py-12 text-center text-slate-500">Belum ada data jabatan.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
